...
// Source: github.com/ShadrackAdwera/go-gRPC/db/sqlc (interfaces: TxStore)
...
func (m *MockTxStore) CreateUserTx(arg0 context.Context, arg1 db.CreateUserTxInput) (db.CreateUserTxOutput, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "CreateUserTx", arg0, arg1)
	ret0, _ := ret[0].(db.CreateUserTxOutput)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
