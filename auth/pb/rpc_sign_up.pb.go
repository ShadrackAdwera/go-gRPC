...
var file_rpc_sign_up_proto_rawDesc = []byte{
	...
	0x2f, 0x53, 0x68, 0x61, 0x64, 0x72, 0x61, 0x63, 0x6b, 0x41, 0x64, 0x77, 0x65, 0x72, 0x61, 0x2f,
	0x67, 0x6f, 0x2d, 0x67, 0x52, 0x50, 0x43, 0x2f, 0x70, 0x62, 0x62, 0x06, 0x70, 0x72, 0x6f, 0x74,
	0x6f, 0x33,
}

var (
	file_rpc_sign_up_proto_rawDescOnce sync.Once
	file_rpc_sign_up_proto_rawDescData = file_rpc_sign_up_proto_rawDesc
)

func file_rpc_sign_up_proto_rawDescGZIP() []byte {
	file_rpc_sign_up_proto_rawDescOnce.Do(func() {
		file_rpc_sign_up_proto_rawDescData = protoimpl.X.CompressGZIP(file_rpc_sign_up_proto_rawDescData)
	})
	return file_rpc_sign_up_proto_rawDescData
}

var file_rpc_sign_up_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_rpc_sign_up_proto_goTypes = []interface{}{
...
func file_rpc_sign_up_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_rpc_sign_up_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_rpc_sign_up_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_rpc_sign_up_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
	...
	file_rpc_sign_up_proto_rawDesc = nil
